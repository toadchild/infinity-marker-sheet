...
EOF
    ...
    print "<p>Vectorized faction logos created by Vyo on the forum. Human Sphere and Paradiso icons extracted by Killian (Deep-Green-X).  Round command token created by Jakob Kantor. Data Pack and Locked markers by Tristan228.</p>\n";
    print <<EOF;
</body>
</html>
EOF
